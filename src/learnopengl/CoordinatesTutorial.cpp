...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Model transformation moves the object model to its location in the world
        // glm::mat4 model;
        ...
        //   (GLfloat)glfwGetTime() * glm::vec3(0.0f, 0.0f, -0.8f));
        ...
        view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f) 
             + (GLfloat)glfwGetTime() * glm::vec3(0.0f, 0.0f, -0.5f));
